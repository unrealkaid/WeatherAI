...
def alert_popup(title, message, path):
    """
    Updated by: Marcus Kline
    Description: Generate a pop-up window for special messages.
    :param title: text that appears at the top of the window
    :param message: text that appears at the center of the window
    :param path:
    :return: None
    """
    root = Tk()
    ...
    relative_x_position = (screen_width - popup_window_width) / 2
    relative_y_position = (screen_height - popup_window_height) / 2
    root.geometry('%dx%d+%d+%d' % (popup_window_width, popup_window_height, relative_x_position, relative_y_position))
    message += '\n'
    message += path
    popup_window_width = Label(root, text=message, width=120, height=10)
    popup_window_width.pack()
    continue_button = Button(root, text="Continue", command=root.destroy, width=10)
...
class Window(Frame):
    ...
    def init_window(self):
        ...
        canvas = Canvas(height=WINDOW_HEIGHT, width=WINDOW_WIDTH)
        canvas.pack()
        upper_frame = Frame(bg='#525453')
        upper_frame.place(relx=0, rely=.05, relwidth=1, relheight=.95)
        label = Label(upper_frame, text="Training AI to Predict Temperature\n" + "by\n" + "Jason, Swatt, and Tiger",
                      bg='#525453', fg='white', font=100)
        label.place(relx=0, rely=0, relwidth=1, relheight=.4)
        navigation_frame = Frame(bg='gray')
        navigation_frame.place(relx=0, rely=0, relwidth=1, relheight=.05)
        # Navigation buttons
        home_navigation_button = Button(navigation_frame, text="Main", borderwidth=5, bg='white', fg='black',
                                        command=self.init_window)
        home_navigation_button.place(relx=0, rely=0, relwidth=.1, relheight=1)
        test_navigation_button = Button(navigation_frame, text="Test", borderwidth=5, bg='white', fg='black',
                                        command=self.init_Test)
        test_navigation_button.place(relx=.1, rely=0, relwidth=.1, relheight=1)
        train_navigation_button = Button(navigation_frame, text="Train", borderwidth=5, bg='white', fg='black',
                                         command=self.init_Train)
        train_navigation_button.place(relx=.2, rely=0, relwidth=.1, relheight=1)
        ...
        city_option_navigation_button = Button(navigation_frame, text="CityOptions", borderwidth=5, bg='white',
                                               fg='black', command=self.expand_Options)
        city_option_navigation_button.place(relx=.3, rely=0, relwidth=.1, relheight=1)
    ...
    def init_Train(self):
        ...
        # make buttons
        v = StringVar()
        historic_button = Radiobutton(upperframe, variable=v, value="hist", text="Historic Data", borderwidth=5,
                                      bg='#525453', fg='white', command=lambda: historic_label(self))
        historic_button.place(relx=.03, rely=.1)
        historic_button.select()
        user_button = Radiobutton(upperframe, variable=v, value="user", text="User Data", borderwidth=5, bg='#525453',
                                  fg='grey', command=lambda: user_label(self))
        ...
        run_button = Button(upperframe, text="Run", borderwidth=5, bg='white', fg='black',
                            command=lambda: run_train(self), state=DISABLED)
    ...
    def init_Test(self):
        ...
        entry_button = Button(upperframe, text="Enter Data", fg="black", bg="white", font=100,
                              command=lambda: open_manual_entry(self))
        # hr
        divide_label = Label(upperframe,
                             text=".....................................................................................................................................................................................................................................................................",
                             fg="white", bg='#525453',
        ...
        run_label = Label(upperframe, text="Press the button below to begin generate a predicion", font="100",
                          bg='#525453',
                          fg='white')
    ...
    def user_input(self):
        ...
        intro_label = Label(upper_frame, text="Now, finish the input box to create your own data object:", fg="pink",
                            bg='#525453', font=200)
        intro_label.pack()
        cont = BooleanVar()
        cont.set(True)
        ...
        while cont.get():
            cont.set(False)
            user_city = simpledialog.askstring(title="Step0", prompt="Please enter city:")
            ...
            USER_INP12 = simpledialog.askstring(title="Continue?",
                                                prompt="Do you want to input another piece of data? (y/Y for yes)")

            if (USER_INP12 == "y" or USER_INP12 == "Y"):
                cont.set(True)
        #
        testOutput0 = Label(upper_frame, text=user_city, bg='#525453')
        testOutput0.place(relx=0, rely=.1, relwidth=1, relheight=.03)
        testOutput1 = Label(upper_frame, text=USER_INP1, bg='#525453')
        testOutput1.place(relx=0, rely=.1, relwidth=1, relheight=.03)
        testOutput2 = Label(upper_frame, text=USER_INP2, bg='#525453')
        testOutput2.place(relx=0, rely=.12, relwidth=1, relheight=.02)
        testOutput3 = Label(upper_frame, text=USER_INP3, bg='#525453')
        testOutput3.place(relx=0, rely=.14, relwidth=1, relheight=.02)
        testOutput4 = Label(upper_frame, text=USER_INP4, bg='#525453')
        testOutput4.place(relx=0, rely=.16, relwidth=1, relheight=.02)
        testOutput5 = Label(upper_frame, text=USER_INP5, bg='#525453')
        testOutput5.place(relx=0, rely=.18, relwidth=1, relheight=.02)
        testOutput6 = Label(upper_frame, text=USER_INP6, bg='#525453')
        testOutput6.place(relx=0, rely=.20, relwidth=1, relheight=.02)
        testOutput7 = Label(upper_frame, text=USER_INP7, bg='#525453')
        testOutput7.place(relx=0, rely=.22, relwidth=1, relheight=.02)
        testOutput8 = Label(upper_frame, text=USER_INP8, bg='#525453')
        testOutput8.place(relx=0, rely=.24, relwidth=1, relheight=.02)
        testOutput9 = Label(upper_frame, text=USER_INP9, bg='#525453')
        testOutput9.place(relx=0, rely=.26, relwidth=1, relheight=.02)
        testOutput10 = Label(upper_frame, text=USER_INP10, bg='#525453')
        testOutput10.place(relx=0, rely=.28, relwidth=1, relheight=.02)
        testOutput11 = Label(upper_frame, text=USER_INP11, bg='#525453')
        testOutput11.place(relx=0, rely=.30, relwidth=1, relheight=.02)
        testOutput12 = Label(upper_frame, text=USER_INP12, bg='#525453')
    ...
    def expand_Options(self):
        ...
        intro_label = Label(upperframe,
                            text="Edit the surroundings city options testing and training using the options below:",
                            fg="pink", bg='#525453', font=200)
        intro_label.pack()
        ...
        def addCityOption(self):
            USER_INP1 = simpledialog.askstring(title="Update",
                                               prompt="Please enter the City name you want to add to the list:")  #
        ...
        def file_prep(self):
            ...
            alert_popup("success", "Your city options list have been refreshed!",
                        "Return to the Train or Test menu to see your changes.")
            f.close()
